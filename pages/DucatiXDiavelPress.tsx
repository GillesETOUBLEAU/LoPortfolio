...
interface DucatiXDiavelPressProps {
  onBack: () => void;
}

export const DucatiXDiavelPress: React.FC<DucatiXDiavelPressProps> = ({ onBack }) => {
  return (
      ...
      <div className="w-full max-w-5xl mx-auto relative z-10 flex items-center justify-center py-20">
        <div className="w-full aspect-video rounded-xl-custom overflow-hidden shadow-2xl">
          <iframe
            width="100%"
            height="100%"
            src="https://www.youtube.com/embed/wPvdNaOfQJI?si=q6APydvrdg_4PjLB"

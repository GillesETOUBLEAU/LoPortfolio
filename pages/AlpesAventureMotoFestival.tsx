...
interface AlpesAventureMotoFestivalProps {
  onBack: () => void;
}

export const AlpesAventureMotoFestival: React.FC<AlpesAventureMotoFestivalProps> = ({ onBack }) => {
  const [selectedImage, setSelectedImage] = useState<string | null>(null);

  const imageUrl = 'https://ndbqdwlncrtrjztuiwvv.supabase.co/storage/v1/object/public/Images/68075dd2-1d43-464e-a8b1-814f49244abf/1763928212078-rirlri.png';
      ...
      <div className="w-full max-w-7xl mx-auto relative z-10 overflow-y-auto py-20">
        ...
        <div className="flex justify-center">
          ...
          >
            <img
              src={imageUrl}
              alt="Alpes Aventure Moto Festival Ride with Antoine MEO"

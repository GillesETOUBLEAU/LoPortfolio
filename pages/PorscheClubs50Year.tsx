...
interface PorscheClubs50YearProps {
  onBack: () => void;
}

export const PorscheClubs50Year: React.FC<PorscheClubs50YearProps> = ({ onBack }) => {
  const [selectedImage, setSelectedImage] = useState<string | null>(null);

  const imageUrl = 'https://ndbqdwlncrtrjztuiwvv.supabase.co/storage/v1/object/public/Images/68075dd2-1d43-464e-a8b1-814f49244abf/1763928211697-t7bzl.jpg';
      ...
      <div className="w-full max-w-7xl mx-auto relative z-10 overflow-y-auto py-20">
        ...
        <div className="flex justify-center">
          ...
          >
            <img
              src={imageUrl}
              alt="Porsche Clubs 50 year Le Mans Pit Lane Diner"
